...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	{
		MessageBox(NULL, TEXT("Log file can not be created"), TEXT("Error"), MB_OK | MB_ICONERROR);
		exit(0);
	}
	else
	{
	...
	{
		fprintf_s(gpFile, "Initialization Suceeded\n\n");
	}
...
int initialize(void)
{
	...
	*/
	...
	loadTexture(&texture_marble, MAKEINTRESOURCE(ID_BITMAP));
...
void display(void)
{
	...
	rotationMatrix = vmath::rotate(angle_rotate, 0.0f, 1.0f, 0.0f);
	perspectiveProjectionMatrix = vmath::perspective(45.0f,((GLfloat)target_texture_width / (GLfloat)target_texture_height),0.1f,100.0f);
...
{
	//code
	angle_rotate = angle_rotate + 0.05f;
