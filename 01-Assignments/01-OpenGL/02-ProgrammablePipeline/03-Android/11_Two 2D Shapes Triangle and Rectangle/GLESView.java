package com.AMD.tri_rec_yellow;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void initialize()
	{
		...
		*/
		...
		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER, triangleVertices.length * 4, positionBuffer, GLES31.GL_STATIC_DRAW);
	...
	//--------------------------------------------------------------------------------------------------------------
		...
		ByteBuffer byteBuffer1 = ByteBuffer.allocateDirect(rectangleVertices.length * 4);	
		...
		positionBuffer1.put(rectangleVertices);
		...
		//fill the buffer data statically
		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER, rectangleVertices.length * 4, positionBuffer1, GLES31.GL_STATIC_DRAW);
