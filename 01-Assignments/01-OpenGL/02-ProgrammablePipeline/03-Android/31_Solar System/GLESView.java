...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private int year = 0, day = 0, moon = 0;
	...
	private void display()
	{
		...
		//translateM(float[] m, int mOffset, float x, float y, float z)
		//Translates matrix m by x, y, and z in place.
		Matrix.translateM(translationMatrix, 0, -2.5f, 0.0f, -6.0f);
		Matrix.multiplyMM(modelViewMatrix,0,
						  modelViewMatrix,0,
						  translationMatrix,0);	
		...
		//static void	setRotateM(float[] rm, int rmOffset, float a, float x, float y, float z)
		//Creates a matrix for rotation by angle a (in degrees) around the axis (x, y, z).
		Matrix.setRotateM(rotationMatrix , 0, year, 1.0f, 0.0f, 0.0f);
		Matrix.multiplyMM(modelViewMatrix,0,
						  modelViewMatrix,0,
						  rotationMatrix,0);
		...
		Matrix.setRotateM(rotationMatrix , 0, day, 1.0f, 0.0f, 0.0f);
		Matrix.multiplyMM(modelViewMatrix,0,
						modelViewMatrix,0,
						rotationMatrix,0);
		...
		Matrix.setRotateM(rotationMatrix , 0, moon, 1.0f, 0.0f, 0.0f);
		Matrix.multiplyMM(modelViewMatrix,0,
						modelViewMatrix,0,
						rotationMatrix,0);										
