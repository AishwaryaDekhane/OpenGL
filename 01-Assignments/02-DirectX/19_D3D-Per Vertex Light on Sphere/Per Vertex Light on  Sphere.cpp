...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//code
	//create log file
	if (fopen_s(&gpFile, gszLogFileName_ap, "w") != 0)
	{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("Direct3D11 Per Vertex Light on Sphere"),
	...
	if (FAILED(hr))
	{
		fopen_s(&gpFile, gszLogFileName_ap, "a+");
