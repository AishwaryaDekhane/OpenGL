...
GLfloat angle_rotate_sphere = 0.0f;
...
void update(void)
{
	angle_rotate_sphere = angle_rotate_sphere + 0.05f;
	if (angle_rotate_sphere >= 360.0f)
		angle_rotate_sphere = angle_rotate_sphere - 360.0f;
