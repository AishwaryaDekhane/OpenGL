...
void display(void)
{
	...
	//ratationMatrix = rotate(0.0f, 1.0f, 0.0f, 0.0f);
	...
	//do necessary transformation if ant require
	
	translationMatrix = translate(-1.5f, 0.0f, -6.0f);
	modelViewMatrix = modelViewMatrix * translationMatrix;

	ratationMatrix = rotate((GLfloat)year, 0.0f, 1.0f, 0.0f);
	modelViewMatrix = modelViewMatrix * ratationMatrix;

	translationMatrix = translate(-1.5f, 0.0f, -6.0f);
	modelViewMatrix = modelViewMatrix * translationMatrix;

	ratationMatrix = rotate((GLfloat)day, 0.0f, 1.0f, 0.0f);
	modelViewMatrix = modelViewMatrix * ratationMatrix;
	...
	ratationMatrix = rotate((GLfloat)moon, 0.0f, 1.0f, 0.0f);
	modelViewMatrix = modelViewMatrix * ratationMatrix;
