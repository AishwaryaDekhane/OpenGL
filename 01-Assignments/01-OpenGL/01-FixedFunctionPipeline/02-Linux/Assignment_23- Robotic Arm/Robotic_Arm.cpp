...
void display(void)
{
	...
	glColor3f(0.5f, 0.35f, 0.05f);//brownish skin color

	glTranslatef(0.0f, 0.0f, -12.0f); //move model

	glPushMatrix();

	glRotatef((GLfloat)Sholder, 0.0f, 0.0f, 1.0f); //z-axis

	glTranslatef(1.0f, 0.0f, 0.0f);

	glPushMatrix();

	//matrix starts at mid before scaling
