...
void display(void)
{
	...
	//this commented code having output like screenshot but in ortho

	/*for (GLfloat i = 0.1;i <= 1;i = i + 0.1)
	{
		glColor3f(0.0f, i, i);
	...
	//Now this code contains code having output like screenshot_new but in perspective
