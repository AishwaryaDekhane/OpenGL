...
int year = 0, day = 0, moon = 0, day1 = 0;
...
void display(void)
{
	...
	gluSphere(quadric, 0.75f, 30, 30); //for sun
	...
	glRotatef((GLfloat)year, 0.0f, 1.0f, 0.0f);	//rotate around sun - revolution

	glTranslatef(1.5f, 0.0f, 0.0f);

	glRotatef(90.0f, 1.0f, 0.0f, 0.0f); //rotate earth model

	glRotatef((GLfloat)day, 0.0f, 0.0f, 1.0f); //y-axis to x-axis

	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);

	quadric = gluNewQuadric();

	glColor3f(0.4f, 0.9f, 1.0f); //bluish color
	...
	glRotatef((GLfloat)year, 0.0f, 1.0f, 0.0f);	//revolution (rotate->translate)

	glTranslatef(1.5f, 0.0f, 0.0f);

	glRotatef(90.0f, 1.0f, 0.0f, 0.0f); //rotate moon model

	glRotatef((GLfloat)day, 0.0f, 0.0f, 1.0f); //y-axis to x-axis		rotation(translate->rotate)
	...
	glColor3f(0.925f, 0.9411f, 0.807f); //whitish color

	gluSphere(quadric, 0.075f, 20, 20);
