...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void initializeCube()
	{
		...
		ByteBuffer byteBufferAPos = ByteBuffer.allocateDirect(cubeVertices.length * 4);
		byteBufferAPos.order(ByteOrder.nativeOrder());
		FloatBuffer positionBufferA = byteBufferAPos.asFloatBuffer();
		positionBufferA.put(cubeVertices);
		positionBufferA.position(0);
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, cubeVertices.length * 4, positionBufferA, GLES32.GL_STATIC_DRAW);
		...
		Buffer.put(cubeNormals);
		Buffer.position(0);
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, cubeNormals.length * 4, Buffer, GLES32.GL_STATIC_DRAW);
	...
	private void display()
	{
		...
		//ratationMatrix = rotate(angle_cube, 1.0f, 1.0f, 1.0f);
